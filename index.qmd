...
The webtext was built using [Quarto](https://quarto.org/), an open-source scientific and technical publishing system in combination with [RStudio](https://posit.co/download/rstudio-desktop/). While we don't have access to the proprietary tools featured in our two cases, Quarto allows us to approximate some of the strategies these tools support.  
